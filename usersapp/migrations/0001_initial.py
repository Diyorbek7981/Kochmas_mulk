    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_status', models.CharField(choices=[('new', 'new'), ('code_verified', 'code_verified'), ('done', 'done'), ('photo_done', 'photo_done'), ('forget_password', 'forget_password')], default='new', max_length=31)),
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True)),
                ('phone_number', models.CharField(blank=True, max_length=13, null=True, unique=True)),
                ('new_phone', models.CharField(blank=True, max_length=13, null=True, unique=True)),
